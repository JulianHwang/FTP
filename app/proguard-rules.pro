...
-keep public class * extends com.lmq.main.api.BaseActivity.java
...
-keep class com.uns.pay.example.**{*;}
...
-keep class com.lmq.hfcg.**$JsOperation  {
*;
}


-keep class com.lmq.hfcg_yx.**$JsOperation  {
*;
}
