package com.dc.ftp.view.mzbanner;
...
import com.dc.ftp.view.mzbanner.transformer.CoverModeTransformer;
import com.dc.ftp.view.mzbanner.transformer.ScaleYTransformer;
...
public class MZBannerView<T> extends RelativeLayout {
    ...
    private int []mIndicatorRes= new int[]{R.mipmap.b_dx2,R.mipmap.b_dx1};
